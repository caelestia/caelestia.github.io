...
> Proof. $\sigma\in\operatorname{Gal}(E/F)$ is mapped to $(\sigma|_K)_K$. Conversely, the preimage of $(s_K)_K$ maps $x\in E$ to $s_K(x)$, where $K$ is *any* Galois subextension containing $x$.
